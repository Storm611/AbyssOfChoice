...
private:
    ...
    void initializeLevels() {
        // Уровень 1 (начальный)
        levels.emplace("1", Level("1", { Enemy(30, 5, 8, 2, 20, 10) }, 50, 30, { "1.1", "1.2", "1.3" }));

        // Уровни 1.X
        levels.emplace("1.1", Level("1.1", { Enemy(40, 7, 10, 3, 25, 15) }, 60, 40, { "2.1", "2.2" }));
        levels.emplace("1.2", Level("1.2", { Enemy(50, 8, 12, 4, 30, 20) }, 70, 50, { "2.1", "2.2", "2.3" }));
        levels.emplace("1.3", Level("1.3", { Enemy(60, 10, 15, 5, 35, 25) }, 80, 60, { "2.2", "2.3" }));
